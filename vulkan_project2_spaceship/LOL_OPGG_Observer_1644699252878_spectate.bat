...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "spectator spectator.kr.lol.riotgames.com:80 ozxlSbrUqS50wmP+V93bR7kG6/LVRH5d 5755006659 KR" "-UseRads" "-Locale=!locale!" "-GameBaseDir=.."
		goto :eof
	)
)
